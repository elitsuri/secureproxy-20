/* database.c — SQLite database layer for secureproxy */
#include "database.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int db_init(const char *path) {
    ...
    const char *schema =
        "CREATE TABLE IF NOT EXISTS secureproxy_records ("
...
int db_insert(const char *name, const char *value) {
    const char *sql = "INSERT INTO secureproxy_records (name, value) VALUES (?, ?);";
    sqlite3_stmt *stmt;
